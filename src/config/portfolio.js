...
export const projects = [
  ...
  {
    id: 6,
    title: "Projeto - Analise de Credito",
    description: "💳 Modelo de avaliação de risco em desenvolvimento.",
    longDescription: "Projeto de análise de crédito utilizando técnicas de machine learning. Detalhes completos em breve.",
  ...
  {
    id: 7,
    title: "Projeto - People Analytics",
    description: "👥 Estudo de dados de RH para insights estratégicos.",
    longDescription: "Em breve disponibilizarei os resultados da aplicação de People Analytics para tomada de decisão em gestão de pessoas.",
    technologies: ["Python"],
    category: "Análise Geoespacial",
    image: "",
    github: "",
  ...
  {
    id: 8,
    title: "Projeto - Previsao de Demandas",
    description: "📈 Modelagem de séries temporais em desenvolvimento.",
    longDescription: "Projeto focado em previsão de demandas utilizando algoritmos de série temporal. Detalhes e códigos serão publicados em breve.",
    technologies: ["Python"],
    category: "Análise Geoespacial",
    image: "",
    github: "",
  ...
  {
    id: 9,
    title: "Projeto - Escore anti fraude",
    description: "🛡️ Sistema de detecção de fraudes em planejamento.",
    longDescription: "Modelo de escore antifraude com métodos estatísticos e machine learning. Conteúdo em breve.",
    technologies: ["Python"],
    category: "Análise Geoespacial",
    image: "",
    github: "",
  ...
  {
    id: 12,
    title: "Projeto Eng-Dados 002 Data Leke",
  ...
  {
    id: 16,
    title: "Data lake no Databrinks - O Lago do Mago",
    description: "✨ Implementação de data lake avancada em andamento.",
